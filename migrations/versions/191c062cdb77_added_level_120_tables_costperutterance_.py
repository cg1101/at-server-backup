...
def upgrade():
    ...
    sa.Column('cutofftime', postgresql.TIMESTAMP(timezone=True), nullable=False),
    ...
    sa.Column('lastupdated', postgresql.TIMESTAMP(timezone=True), nullable=False),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_subtasks_taskid_worktypeid_name'), table_name='subtasks')
    op.drop_index('ix_subtasks_taskid', table_name='subtasks')
