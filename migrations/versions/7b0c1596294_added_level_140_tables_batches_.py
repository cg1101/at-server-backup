...
def upgrade():
    ...
    sa.Column('leasegranted', postgresql.TIMESTAMP(timezone=True), nullable=True),
    sa.Column('leaseexpires', postgresql.TIMESTAMP(timezone=True), nullable=True),
    ...
    sa.Column('lastupdated', postgresql.TIMESTAMP(timezone=True), nullable=True),
