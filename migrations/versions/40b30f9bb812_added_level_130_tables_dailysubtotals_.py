...
def upgrade():
    ...
    sa.Column('validfrom', postgresql.TIMESTAMP(timezone=True), server_default=sa.text(u'now()'), nullable=False),
    sa.Column('multiplier', postgresql.DOUBLE_PRECISION(), server_default=sa.text(u'1'), nullable=False),
    sa.Column('updatedby', sa.INTEGER(), nullable=False),
    sa.Column('updatedat', postgresql.TIMESTAMP(timezone=True), server_default=sa.text(u'now()'), nullable=True),
    ...
    sa.Column('selected', postgresql.TIMESTAMP(timezone=True), server_default=sa.text(u'now()'), nullable=False),
    sa.Column('action', sa.TEXT(), nullable=True),
    sa.Column('subtaskid', sa.INTEGER(), nullable=True),
    sa.Column('name', sa.TEXT(), nullable=True),
    sa.Column('processed', postgresql.TIMESTAMP(timezone=True), nullable=True),
    ...
    sa.Column('taskid', sa.INTEGER(), nullable=False),
    sa.Column('subtaskid', sa.INTEGER(), nullable=False),
    sa.Column('starttime', postgresql.TIMESTAMP(timezone=True), server_default=sa.text(u'now()'), nullable=False),
    sa.Column('endtime', postgresql.TIMESTAMP(timezone=True), nullable=True),
