...
def init_db(engine):
	...
	pdb_engine = create_engine(pdb_url)
	...
	ao_engine = create_engine(ao_url)
	...
	at_engine = create_engine(at_url)

	# if not is_remote: # only do this in office
	...
	# 			m.Answer, m.Marking, m.TaskType, m.WorkType, m.FileHandler,
	# 		]:
