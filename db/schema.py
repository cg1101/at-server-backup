...
t_subtasks =  Table('subtasks', metadata,
	...
	Column("enforce_checking_criteria", BOOLEAN, nullable=False, default=True),
...
t_ph_consonants =  Table('ph_consonants', metadata,
	...
	Column('voicing', TEXT, nullable=True, key=u'voicing', doc=''),
	Column('place', TEXT, nullable=True, key=u'place', doc=''),
	Column('manner', TEXT, nullable=True, key=u'manner', doc=''),
	Column('central_lateral', TEXT, nullable=True, key=u'centralLateral', doc=''),
	Column('coarticulation', TEXT, nullable=True, key=u'coarticulation', doc=''),
	Column('second_place', TEXT, nullable=True, key=u'secondPlace', doc=''),
	Column('diacritic', TEXT, nullable=True, key=u'diacritic', doc=''),
...
t_tracks = Table("tracks", metadata,
	...
	Column("muted", BOOLEAN, nullable=False, default=False, key="muted", doc=""),
	Column("disabled", BOOLEAN, nullable=False, default=False, key="disabled", doc=""),
...
t_performances = Table("performances", metadata,
	...
	Column("locked", BOOLEAN, key="locked", default=False, nullable=False, doc=""),
	Column("in_transcription", JSONB, key="inTranscription", doc=""),
